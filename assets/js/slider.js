...
// Slider
export function dragDropSlider(windowParent, window, slideItemsTrack, slideItem, arrowsParent, lenght){
    let slider = document.querySelector(windowParent),
    sliderList = slider.querySelector(window),
    sliderTrack = slider.querySelector(slideItemsTrack),
    slides = slider.querySelectorAll(slideItem),
    ...
    slide = function() {
        ...
        prev.classList.toggle('disabled', slideIndex === 0);
        next.classList.toggle('disabled', slideIndex === (length - 1));
    },
    swipeStart = function() {
        let evt = getEvent();
